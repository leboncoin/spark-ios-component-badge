//
//  BadgeGetIntentColorsUseCaseDeprecatedTests.swift
//  SparkDemo
//
...
final class BadgeGetIntentColorsUseCaseDeprecatedTests: XCTestCase {
    ...
    func test_execute_for_all_variant_cases() throws {
        ...
        for item in items {
            let useCase = BadgeGetIntentColorsUseCaseDeprecated()
...
private struct Tester {
    ...
    static func testColorsProperties(
        givenColors: BadgeColorsDeprecated,
