//
//  BadgeGetSizeAttributesUseCaseDeprecated.swift
...
final class BadgeGetSizeAttributesUseCaseDeprecatedTests: XCTestCase {

    // MARK: - Properties
    var sut: BadgeGetSizeAttributesUseCaseDeprecated!
    ...
    override func setUp()  {
        super.setUp()
        self.theme = .mocked()
        self.sut = BadgeGetSizeAttributesUseCaseDeprecated()
    }
