//
//  BadgeViewModelDeprecated.swift
//  SparkComponentBadge
//
...
/// **BadgeViewModelDeprecated** is a view model that is required for
...
final class BadgeViewModelDeprecated: ObservableObject {
    ...
    @Published var border: BadgeBorderDeprecated
    ...
    var colorsUseCase: any BadgeGetIntentColorsUseCaseDeprecatedableDeprecated
    var sizeAttributesUseCase: any BadgeGetSizeAttributesUseCaseDeprecatedableDeprecated
    ...
    init(theme: any Theme,
         ...
         colorsUseCase: any BadgeGetIntentColorsUseCaseDeprecatedableDeprecated = BadgeGetIntentColorsUseCaseDeprecated(),
         sizeAttributesUseCase: any BadgeGetSizeAttributesUseCaseDeprecatedableDeprecated = BadgeGetSizeAttributesUseCaseDeprecated()
    ) {
        ...
        self.border = BadgeBorderDeprecated(
