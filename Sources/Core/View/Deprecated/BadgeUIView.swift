...
@available(*, deprecated, message: "Use SparkUIBadge instead")
public class BadgeUIView: UIView {

    private var viewModel: BadgeViewModelDeprecated
    ...
    // MARK: - Init
    public init(theme: any Theme, intent: BadgeIntentType, size: BadgeSize = .medium, value: Int? = nil, format: BadgeFormat = .default, isBorderVisible: Bool = false) {
        self.viewModel = BadgeViewModelDeprecated(theme: theme, intent: intent, size: size, value: value, format: format, isBorderVisible: isBorderVisible)
...
extension BadgeUIView {
    private func updateBorder(_ badgeBorder: BadgeBorderDeprecated, isBorderVisible: Bool) {
