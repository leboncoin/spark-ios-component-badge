...
///    }
/// ```
@available(*, deprecated, message: "Use SparkBadge instead")
public struct BadgeView: View {
    @ObservedObject private var viewModel: BadgeViewModelDeprecated
    ...
    public init(theme: any Theme, intent: BadgeIntentType, value: Int? = nil) {
        let viewModel = BadgeViewModelDeprecated(theme: theme, intent: intent, value: value)
